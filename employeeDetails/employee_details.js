...
function findSpecialization(speci) {
    const speciEmployee = employees.find(employee => employee.specialization === speci);
    if (speciEmployee) {
        document.getElementById('employeesDetails').innerHTML =`<p>${speciEmployee.id}: ${speciEmployee.name} - ${speciEmployee.department} - ${speciEmployee.specialization}</p>`;
    }
    else {
